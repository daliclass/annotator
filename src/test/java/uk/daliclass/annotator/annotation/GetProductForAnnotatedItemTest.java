...
public class GetProductForAnnotatedItemTest {
    ...
    private static final List<ItemFact> ITEM_FACTS = new ArrayList<>() {{
        add(new ItemFact(1, new Fact(Fact.Predicate.SUITABLE_FOR, Fact.Object.MEN)));
        add(new ItemFact(1, new Fact(Fact.Predicate.SUITABLE_FOR, Fact.Object.FEMALE)));
        add(new ItemFact(2, new Fact(Fact.Predicate.SUITABLE_FOR, Fact.Object.FEMALE)));
    }};
    private static final List<Fact> EXPECTED_ITEM_FACTS = new ArrayList<>() {{
        add(new Fact(Fact.Predicate.SUITABLE_FOR, Fact.Object.MEN));
        add(new Fact(Fact.Predicate.SUITABLE_FOR, Fact.Object.FEMALE));
    }};
